        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://zdielaj.si/" className="flex items-center">
              <img src="/zdielaj-si-small.png" width={40} height={40} className="h-10 me-3" alt="Zdielaj.si logo" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Zdielaj.si</span>
            </a>
