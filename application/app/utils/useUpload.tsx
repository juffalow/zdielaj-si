...
interface UploadContextType {
  ...
  uploadSpeed: number;
  clear: () => void,
  onDrop: (acceptedFiles: FileWithPath[], onUpload?: (media: AlbumFile) => Promise<void> | void) => Promise<unknown>;
...
export function UploadProvider({ children }: { children: ReactNode }): React.ReactNode {
  ...
  const onDrop = async (acceptedFiles: FileWithPath[], onUpload?: (media: AlbumFile) => Promise<void> | void): Promise<unknown> => {
