...
const NotFound = () => {
  ...
  return (
    <Alert color="warning" hideIcon={true}>
      ...
      <Button as={Link} to={`/${t("routes.prefix")}${t("routes.home")}`} variant="bordered" className="w-100 mx-auto" data-tracking-id="public_profile_not_found_click">{t("publicProfile.notFound.ctaButton")}</Button>
    </Alert>
  );
}
