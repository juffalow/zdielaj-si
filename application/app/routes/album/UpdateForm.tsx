...
export default function UpdateForm({ album }: { album: Album }) {
  ...
  const [state, formAction, isPending] = useActionState(onSubmit, { name: album.name, description: album.description, layout: album.layout, gaps: album.gaps, retention: album.retention, changeLayout: album.changeLayout });
