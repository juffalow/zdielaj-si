...
const MobileBottomButton = ({ children, link }: Props) => {
  ...
  return createPortal(
    <div className="relative">
      <div className="fixed w-full pt-4 pb-4 text-center" style={{ bottom: 0, backgroundColor: 'rgba(153, 153, 153, 0.6)', zIndex: 999 }}>
        <Button color="primary" onPress={onCopyClick} className="w-100" size="lg" data-tracking-id="album_mobile_button_copy_click">{children}</Button>
      </div>
    </div>
  , document.body);
}
